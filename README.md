Lern-project-3. Лэндинг магазина текстиля.


О проекте

Обретение новых навыков в вёрстке (Flexbox, Grid). Стек HTML/CSS/SCSS/JS. На базе JS создал два вида слайдеров, также работа бургера и всплывающего меню. Использовал шрифт-иконки FontAwesome (https://fontawesome.com). Адаптив представлен десктопной, планшетной и мобильной версиями. Дизайн от Евгении Иванайской (https://vk.ru/ohjeni). Код по ссылке: https://github.com/ivanays/lern-project-3.local. Создан в 2022 году.  
